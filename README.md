...
Free, self-hosted graded Chinese reader + flashcards. Your own AI coding agent generates content at your level; a Cloudflare Pages app handles reading and [FSRS](https://github.com/open-spaced-repetition/ts-fsrs) spaced repetition. Hosting cost: $0.
